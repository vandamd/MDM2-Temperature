...
geothermal_power = 0                            # power output of the generator
...
def Insulation_model(y,t):
    ...
    dQ1dt = ((A_Wall_1_2)*(k_wall/Insulation_wall_thickness)*(T2-T1)) + ((A_Wall_1_o)*(k_wall/Insulation_wall_thickness)*(Tins1-T1)) + ((A_Wall_1_o)*(k_wall/Insulation_wall_thickness)*(Tins4-T1)) + ((A_Wall_1_o)*(k_wall/Insulation_wall_thickness)*(Tins3-T1)) + ((A_room1)*(k_wall/Thickness_wall)*(To-T1)) + geothermal_power
    dQ2dt = ((A_Wall_1_2)*(k_wall/Insulation_wall_thickness)*(T1-T2)) + ((A_Wall_3_2)*(k_wall/Insulation_wall_thickness)*(T3-T2)) + ((A_Wall_2_o)*(k_wall/Insulation_wall_thickness)*(Tins1-T2)) + ((A_Wall_2_o)*(k_wall/Insulation_wall_thickness)*(Tins3-T2)) + ((A_room2)*(k_wall/Thickness_wall)*(To-T2)) + geothermal_power
    dQ3dt = ((A_Wall_3_2)*(k_wall/Insulation_wall_thickness)*(T2-T3)) + ((A_Wall_3_o)*(k_wall/Insulation_wall_thickness)*(Tins1-T3)) + ((A_Wall_3_o)*(k_wall/Insulation_wall_thickness)*(Tins2-T3)) + ((A_Wall_3_o)*(k_wall/Insulation_wall_thickness)*(Tins3-T3)) + ((A_room3)*(k_wall/Thickness_wall)*(To-T3)) + geothermal_power
    ...
    dQodt = 0#-(1/144)*math.pi*math.sin((math.pi*t)/1440)
